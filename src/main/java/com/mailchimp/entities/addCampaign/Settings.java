...
@JsonPropertyOrder({ "subject_line", "preview_text", "title", "from_name", "reply_to", "use_conversation", "to_name",
		"folder_id", "authenticate", "auto_footer", "inline_css", "auto_tweet", "auto_fb_post", "fb_comments",
		"template_id" })
public class Settings {
	...
	private List<Object> autoFbPost = null;
	...
	@JsonProperty("auto_fb_post")
	public List<Object> getAutoFbPost() {
		return autoFbPost;
	}

	@JsonProperty("auto_fb_post")
	public void setAutoFbPost(List<Object> autoFbPost) {
